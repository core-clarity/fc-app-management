...
- 表形式のスケジュールでは、列見出しの「12:30」「18:00」等を開演時刻として扱うこと
- 黒・濃灰色で塗られたセルはその時間帯の公演なし、白・無塗りセルは公演ありとして扱うこと
- 日付が省略された次の行は、直前の日付の別公演として扱うこと
- 黄色・オレンジ等の強調色は、黒・濃灰色と同じ意味とは限らないため、明らかな公演なしでない限り候補から除外しないこと
...
- 申込者名、同行者、当落、入金状態などは公演日程として出力しないこと
